...
def simular_dados_clinicas():
    ...
    clinicas_info = {
        ...
        'CF Adib Jatene (Complexo da Maré)': {'lat': -22.86564, 'lon': -43.23933, 'fator_risco': np.random.uniform(1.0, 1.8)},
        ...
        'CF Eidimir Thiago de Souza (Parada de Lucas)': {'lat': -22.82323, 'lon': -43.30948, 'fator_risco': np.random.uniform(1.0, 1.8)},
        'CF Aloysio Augusto Novis (Penha Circular)': {'lat': -22.83792, 'lon': -43.29003, 'fator_risco': np.random.uniform(1.0, 1.8)},
    }
...
st.sidebar.image("images/logo_prefeitura_rio.png", use_container_width = True)